...
#'
#' @format A data frame with one categorical variable ('V1'), one interger variable ('V8') and 8 numerical variables.
#'
#' @keywords test_abalone
#'
#' @references Warwick J Nash, Tracy L Sellers, Simon R Talbot, Andrew J Cawthorn and Wes B Ford (1994)
