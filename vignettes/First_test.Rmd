...
num_mi <- 4
n_df <- 4
n_resample <- 2#2*round(log(nrow(df_complete)))
...
```{r write_csv}
write.csv(result,"test_MAR1_MissRanger_boot_diff_dfcomp_result.csv")
# read.csv("test_MAR1_PCA_boot_diff_dfcomp_result.csv")
```
