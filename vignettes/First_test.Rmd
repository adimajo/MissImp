...
for(df in ls_boot){
  df = factor_encode(df, idx_col_cat)
  imp.forest = missForest(xmis = df, maxiter = 5, ntree = 100, dict_cat = dict_name_cat)
...
df_full = df_with_mv
df_full = factor_encode(df_with_mv, idx_col_cat)
imp.forest_full = missForest(xmis = df_full, maxiter = 5, ntree = 100, dict_cat = dict_name_cat)
